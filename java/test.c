...
JNIEXPORT void JNICALL Java_Test_initialize_1eiffel_1runtime(JNIEnv * env, jobject obj){
...
JNIEXPORT void JNICALL Java_Test_close_1eiffel_1runtime(JNIEnv * env, jobject obj){
	{ EIF_DISPOSE_ALL // Don't care about the beginning {. It is suppose to be there.
}


// Return a simple Hello World String from Eiffel
JNIEXPORT jstring JNICALL Java_Test_get_1hello_1from_1eiffel (JNIEnv * env, jobject obj){
...
JNIEXPORT jintArray JNICALL Java_Test_get_1fibonacci_1sequence_1from_1eiffel(JNIEnv *env , jobject obj, jint a_number){
	jintArray l_result;
	int * l_fib;
